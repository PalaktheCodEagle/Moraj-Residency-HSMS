...
<head>
    ...
    <title>Skin, Hair and Obesity Clinic</title>
    <link
...
<body>
    ...
    <center><h4 style="font-family: Marcellus, sans-serif; margin-top:100px; font-weight:bold; color:#4C0033!important;">Exploring
        the diverse range of Skin, Hair and Obesity Clinics offered at Moraj</h4></center>
        ...
        <div class="activity-carousel-view">
            ...
            <div id="activity-item-list" class="activity-item-list">
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic1.jpeg" />
                    <p></p>
                </div>
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic2.jpeg" />
                    <p></p>
                </div>
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic3.jpeg" />
                    <p></p>
                </div>
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic4.jpeg" />
                    <p></p>
                </div>
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic5.jpeg" />
                    <p></p>
                </div>
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic6.jpeg" />
                    <p></p>
                </div>
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic7.jpeg" />
                    <p></p>
                </div>
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic8.jpeg" />
                    <p></p>
                </div>
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic9.jpeg" />
                    <p></p>
                </div>
                <div class="activity-item-container">
                    <img class="activity-item" src="/img/clinic10.jpeg" />
                    <p></p>
                </div>
