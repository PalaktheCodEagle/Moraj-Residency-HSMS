...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active" style="text-decoration:none;">Reports</li>
    </ol>
    <?php
...
?>
    <div class="card">
        <div class="card-header" style="background-color:#4C0033;">
            <h5 class="card-title" style="color: #fff;">Report</h5>
        </div>
        <div class="card-body" style="background-color:#fff9e8;">
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <button type="submit" name="generate_report" class="btn btn-primary mt-4"
                        style="background: #430A5D; border: #430A5D;">Generate
                            Report</button>
                    </div>
                </div>
            </form>
