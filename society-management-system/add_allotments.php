...
?>
        <div class="card">
            <div class="card-header" style="background-color:#4C0033;">
                <h5 class="card-title" style="color: #fff;">Add Allotments</h5>
            </div>
            <div class="card-body" style="background-color:#fff9e8;">
                <form method="post">
                    ...
                    <button type="submit" name="add_allotment" class="btn btn-primary" style="background: #430A5D; border: #430A5D;">
