...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="flats.php" style="text-decoration:none;">Flats Management</a></li>
...
?>
        <div class="card">
            <div class="card-header" style="background-color:#4C0033;">
                <h5 class="card-title" style="color:#FFF">Edit Flats Data</h5>
            </div>
                ...
                <form id="add-flat-form" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="flat-number" name="flat_number"
                            value="<?php echo (isset($flat['flat_number'])) ? $flat['flat_number'] : ''; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="floor" class="form-label">Floor</label>
                        <input type="number" class="form-control" id="floor" name="floor"
                            value="<?php echo (isset($flat['floor'])) ? $flat['floor'] : ''; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="floor" class="form-label">Block Number</label>
                        <input type="text" class="form-control" id="block_number" name="block_number"
                            value="<?php echo (isset($flat['block_number'])) ? $flat['block_number'] : ''; ?>">
                    </div>
                    <div class="mb-3">
...
?>
                    ...
                    <button type="submit" name="edit_flats" class="btn btn-primary" style="background: #430A5D; border: none;">Edit Flat</button>
                    <script>
