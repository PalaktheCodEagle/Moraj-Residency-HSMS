...
?>
        <div class="card">
            <div class="card-header" style="background-color: #9b2928;">
                <h5 class="card-title" style="color: #fff;">Edit Complaint</h5>
            </div>
                ...
                <form id="add-flat-form" method="POST">
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="5"
                            placeholder="Enter Complaint Description"><?php echo (isset($complaint['description'])) ? $complaint['description'] : ''; ?></textarea>
                    </div>
