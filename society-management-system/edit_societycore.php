...
if (isset($_POST['edit_user'])) {
    ...
    if (empty($errors)) {
            ...
            $sql = "UPDATE society_core_member SET user_name = ?, role = ?, designation = ? WHERE id = ?";
...
if (isset($_GET['id'])) {
    ...
    $stmt = $pdo->prepare("SELECT * FROM society_core_member WHERE id = ?");
...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Edit Society Core Members Data</li>
    </ol>
    <center>
    <div class="col-md-4">
        <?php
