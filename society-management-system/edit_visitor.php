...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="visitors.php">Visitors Management</a></li>
...
?>
        <div class="card">
            <div class="card-header" style="background-color: #4C0033;">
                <h5 class="card-title" style="color: #fff;">Edit Visitor</h5>
            </div>
...
?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="name" name="name" class="form-control"
                            value="<?php echo (isset($visitor['name'])) ? $visitor['name'] : ''; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="phone">Phone Number</label>
                        <input type="text" id="phone" name="phone" class="form-control"
                            value="<?php echo (isset($visitor['phone'])) ? $visitor['phone'] : ''; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="address">Address</label>
                        <textarea id="address" name="address"
                            class="form-control"><?php echo (isset($visitor['address'])) ? $visitor['address'] : ''; ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="person_to_meet">Person to Meet</label>
                        <input type="text" id="person_to_meet" name="person_to_meet" class="form-control"
                            value="<?php echo (isset($visitor['person_to_meet'])) ? $visitor['person_to_meet'] : ''; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="reason">Reason for Visit</label>
                        <textarea id="reason" name="reason"
                            class="form-control"><?php echo (isset($visitor['reason'])) ? $visitor['reason'] : ''; ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="in_datetime">In Date/Time</label>
                        <input type="datetime-local" id="in_datetime" name="in_datetime" class="form-control"
                            value="<?php echo (isset($visitor['in_datetime'])) ? $visitor['in_datetime'] : ''; ?>">
                    </div>
                    <input type="hidden" name="id"
                        value="<?php echo (isset($visitor['id'])) ? $visitor['id'] : ''; ?>" />
