...
?>
        <div class="card">
            <div class="card-header" style="background-color:#4C0033">
                <h5 class="card-title" style="color: #fff;">Add Flats</h5>
            </div>
...
?>
                    ...
                    <center>
                    <button type="submit" name="add_flats" class="btn btn-primary" style="background-color: #430A5D; border: #430A5D;">
                    Add Flat</button></center>
                </form>
            </div>
        </div>
    </div>
