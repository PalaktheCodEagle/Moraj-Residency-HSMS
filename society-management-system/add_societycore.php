...
if (isset($_POST['add_user'])) {
    ...
    if (empty($errors)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO society_core_member (user_name, role, designation) VALUES (?, ?, ?)");

        $stmt->execute([$user_name, $role, $designation]);

        $_SESSION['success'] = 'Society Core Member Added';
...
<div class="container-fluid px-4">
    <h1 class="mt-4">Add Society Core Members</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="dashboard.php" style="text-decoration:none;">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="societycore.php" style="text-decoration:none;">Society Core Members</a></li>
        <li class="breadcrumb-item active">Add Society Core Members Details</li>
    </ol>
    <center>
    <div class="col-md-4">
        <?php
...
?>
        <div class="card">
            <div class="card-header" style="background-color:#4C0033;">
                <h5 class="card-title" style="color: #fff;">Add Society Core Members Details</h5>
            </div>
