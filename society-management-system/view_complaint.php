...
?>
        <div class="card">
            <div class="card-header" style="background-color:#9b2928">
                <h5 class="card-title" style="color: #fff;">View Complaint</h5>
            </div>
            <div class="card-body" style="background-color:#FFF2E2">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <?php echo (isset($complaint['flat_number'])) ? $complaint['block_number'] . ' - ' . $complaint['flat_number'] : 'NA'; ?>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4"><b>Complaints Details</b></div>
                    <div class="col-md-8">
                        <?php echo (isset($complaint['description'])) ? $complaint['description'] : 'NA'; ?></div>
                </div>
                <?php
                ...
                <form method="post">
                    ...
                    <div class="mb-3">
                        <input type="hidden" name="id"
                            value="<?php echo isset($complaint['id']) ? $complaint['id'] : ''; ?>" />
                        <input type="hidden" name="hidden_description"
                            value="<?php echo isset($complaint['description']) ? $complaint['description'] : ''; ?>" />
                        <input type="hidden" name="hidden_user_id"
                            value="<?php echo isset($complaint['user_id']) ? $complaint['user_id'] : ''; ?>" />
